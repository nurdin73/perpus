                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="klasifikasi" required>
                            <option value="Klasifikasi" selected disabled>Klasifikasi</option>
                            <?php foreach($klasifikasi_data->result() as $data):?>
                            <option value="<?= $data->id;?>" <?= ($edit['klasifikasi'] == $data->id) ? 'selected' : '';?>><?= $data->nama;?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                         <input type="text" name="stock" class="form-control" placeholder="Stock" value="<?php echo $edit['stock']; ?>">
                    </div>
                </div>
