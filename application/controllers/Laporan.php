...
class Laporan extends MY_Controller {
    ...
    public function cetak_lap_pinjam()
    {
        $start = $this->input->post('start');
        $end = $this->input->post('end');
        $data['hasil_search'] = $this->Mod_laporan->cetak($start,$end);
        $this->load->view('laporan/peminjaman_cetak', $data);
    }
    ...
    public function cetak_lap_pengembalian()
    {
        // $tanggal1 = '2018-04-19';
        // $tanggal2 = '2018-04-21';
        $start = $this->input->post('start');
        $end = $this->input->post('end');
        $data['hasil_search'] = $this->Mod_laporan->cetakPengembalian($start,$end);
        $this->load->view('laporan/pengembalian_cetak', $data);
